...
- 01_SYSTEM/NON_NEGOTIABLES.md
- 04_WORKFLOW/TASK_BOARD.md
- 00_CONTEXT/DECISIONS.md

## Working Rules

- Do not modify application code without a clear task.
- Do not make architecture changes without updating 00_CONTEXT/DECISIONS.md.
...
- Update TASK_BOARD.md when a task moves forward.
...
Both tools must follow the same project rules. Git, tests, AGENTS.md, DECISIONS.md, and the project operating-system files remain the source of truth.
